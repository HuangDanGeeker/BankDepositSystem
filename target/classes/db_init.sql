...
-- 4.创建柜员操作记录表
create TABLE recd_staff_1(operType VARCHAR(4), custmNo VARCHAR(20) NOT NULL, custmName VARCHAR(20) NOT NULL, creditCardNo varchar(20) NOT NULL ,nums INT, operDate VARCHAR(10));
